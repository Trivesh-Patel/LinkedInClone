package com.triveshpatel.linkedIn.notification_service.consumer;

import com.triveshpatel.linkedIn.notification_service.clients.ConnectionsClient;
import com.triveshpatel.linkedIn.notification_service.dto.PersonDto;
import com.triveshpatel.linkedIn.notification_service.repository.NotificationRepository;
import com.triveshpatel.linkedIn.posts_service.event.PostCreatedEvent;
import com.triveshpatel.linkedIn.posts_service.event.PostLikedEvent;
import com.triveshpatel.linkedIn.notification_service.service.SendNotification;
